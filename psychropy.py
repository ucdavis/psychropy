...
def psych(P, in0Type, in0Val, in1Type, in1Val, outType, unitType='Imp', index=None):
    isAPanda = False
...
def psyplot(pressure=14.696, t_dry_bulb_start=20, t_dry_bulb_end=110, w_start=0, w_end=0.025, axis_labels=False,
            font_size=16):
    warnings.warn("psyplot is depreciated, use psych_chart()", DeprecationWarning)
    print('DepreciationWarning: psyplot is depreciated, use psych_chart()')
